...
import com.mybatis.plus.mapper.entity.EntityTable;
	...
	protected SqlNode getDynamicTableNameNode(Class<?> entityClass) {
		if (IDynamicTableName.class.isAssignableFrom(entityClass)) {
			...
			ifSqlNodes.add(new IfSqlNode(new TextSqlNode("${dynamicTableName}"),
					"@com.mybatis.plus.mapper.util.OGNL@isDynamicParameter(_parameter) and dynamicTableName != null and dynamicTableName != ''"));
			ifSqlNodes.add(new IfSqlNode(new StaticTextSqlNode(tableName(entityClass)),
					"@com.mybatis.plus.mapper.util.OGNL@isNotDynamicParameter(_parameter) or dynamicTableName == null or dynamicTableName == ''"));
	...
	protected SqlNode getDynamicTableNameNode(Class<?> entityClass, String parameterName) {
		if (IDynamicTableName.class.isAssignableFrom(entityClass)) {
			...
			ifSqlNodes.add(new IfSqlNode(new TextSqlNode("${" + parameterName + ".dynamicTableName}"),
					"@com.mybatis.plus.mapper.util.OGNL@isDynamicParameter(" + parameterName + ") and "
							+ parameterName + ".dynamicTableName != null and  " + parameterName
							+ ".dynamicTableName != ''"));
			ifSqlNodes.add(new IfSqlNode(new StaticTextSqlNode(tableName(entityClass)),
					"@com.mybatis.plus.mapper.util.OGNL@isNotDynamicParameter(" + parameterName + ") or "
							+ parameterName + ".dynamicTableName == null or " + parameterName
							+ ".dynamicTableName == ''"));
			return new MixedSqlNode(ifSqlNodes);
		} else {
			return new StaticTextSqlNode(tableName(entityClass));
